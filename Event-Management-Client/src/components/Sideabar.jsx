            ...
            <nav>
              {role === "admin" && (
                <>
                  ...
                  {/* Menu Links */}
                  {toggle ? (
                    <button className="p-2 border-l-2 shadow-lg">
              ...
              {role === "organizer" && (
                <>
                  <button className="p-2 border-l-2 block mb-2 shadow-lg ">
                    <Link to="/dashboard/addData">Add events</Link>{" "}
                  </button>
                  <button className="p-2 border-l-2 shadow-lg">
                    <Link to="/dashboard/myData">My Data</Link>{" "}
                  </button>
                </>
              )}
              {role !== "admin" && role !== "organizer" && (
                <>
                  ...
                  {/* <button className="p-2 border-l-2 ">
